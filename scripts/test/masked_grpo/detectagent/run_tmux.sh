...
tmux send-keys -t "$SERVER_SESSION" "cd $SCRIPT_DIR/../../../.." C-m
...
tmux send-keys -t "$SERVER_SESSION" "export PYTHONPATH=$SCRIPT_DIR/../../../..:\$PYTHONPATH" C-m
# Start the server
...
tmux send-keys -t "$TRAIN_SESSION" "export PYTHONPATH=$SCRIPT_DIR/../../../..:\$PYTHONPATH" C-m
...
tmux send-keys -t "$TRAIN_SESSION" "python3 -m vagen.trainer.main_ppo \\
    ...
    trainer.project_name='vagen_7b_full_tool_step4v2' \\
